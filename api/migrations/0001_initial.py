# Generated by Django 3.0.5 on 2022-08-10 16:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, max_length=250, null=True, verbose_name='Информация о пользователе')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contry', models.TextField(max_length=25, verbose_name='Страна происхождения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(max_length=50, unique=True, verbose_name='Жанр')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='book', to='api.Genre', verbose_name='Жанр'),
        ),
    ]
